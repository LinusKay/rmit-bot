		...
		if arg is None:
			...
			for link in links:
				...
				if arg.lower() == link_title.lower():
					...
					if link_text_1 != '':
						links_embed.add_field(name=link_title, value=link_text_1.decode("unicode_escape"))
					if link_text_2 != '':
						links_embed.add_field(name=link_title, value=strlink_text_2.decode("unicode_escape"))
