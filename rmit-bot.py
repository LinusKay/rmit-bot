		...
		if arg is None:
			...
			for building in buildings:
				if building.startswith(arg + ','):
					...
					building_embed.set_image(url='https://maps.googleapis.com/maps/api/staticmap?center=' + parse_url + '&zoom=16&size=400x400&key=AIzaSyA6vEH85dgBFj-cuPW38lTXFsY84c-duxk')
